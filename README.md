<br />
<p align="center">
  <a href="https://yesplay.waahah.xyz" target="blank">
  ...
  <p align="center">
    高颜值的第三方网易云播放器
    <br />
    <a href="https://yesplay.waahah.xyz" target="blank"><strong>🌎 访问DEMO</strong></a>&nbsp;&nbsp;|&nbsp;&nbsp;
...
[![Library][library-screenshot]](https://yesplay.waahah.xyz)
...
访问项目的 [Releases](https://github.com/qier222/YesPlayMusic/releases)
页面下载安装包。
...
本项目的 Demo (https://yesplay.waahah.xyz) 就是部署在 Vercel 上的网站。
...
```sh
git clone --recursive https://github.com/waahah/YesPlayMusic.git
```
...
```sh
bash <(curl -s -L https://raw.githubusercontent.com/waahah/YesPlayMusic/main/install-replit.sh)
```
